...
public class MyRestController {
	...
	public Booking_Entity addEmpName(@PathVariable Integer bookingid) {
	    ...
	    Info_Entity user =infoRepo.findByAuthenticationUsername(username);
	    username= user.getFirstName()+" (Admin)"; 
	...
	public ResponseEntity<Booking_Entity> updateSlot(
	    ...
	    Booking_Entity updated = booking.get();
	    updated.setSlotDate(date);
	    updated.setSlotTime(time);
